...
for name in list_vars.keys():
    ...
    ftype = 0;
    if use_f16:
        # wpe.weight (position embeddings) is always loaded as f32 by the
        # ggml GPT-2 inference code, regardless of the model's global ftype
        if name[-7:] == ".weight" and n_dims == 2 and name != "wpe.weight":
    ...
    if (name.endswith(".attn.c_attn.weight") or
